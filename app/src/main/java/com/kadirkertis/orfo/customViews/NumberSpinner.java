package com.kadirkertis.orfo.customViews;
...
public class NumberSpinner extends LinearLayout {
    ...
    private static String SELECTED_VALUE ="selectedValue";
    private static String SUPER_CLASS_STATE ="superState";
    ...
    protected void onFinishInflate() {
        ...
        mIncBtn = (ImageButton) this.findViewById(R.id.spinner_increment);
        mDecBtn = (ImageButton) this.findViewById(R.id.spinner_decrement);
        mResultText = (TextView) this.findViewById(R.id.spinner_current_value);
