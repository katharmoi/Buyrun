...
public class PlaceProfileFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPlaceInfoDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                mPlaceInfo = dataSnapshot.getValue(PlaceInfo.class);
                Picasso.with(getActivity())
                        .load(mPlaceInfo.getImageUrl())
                ...
                mBinding.placeProfileAcPlaceText.setText(mPlaceInfo.getPlaceName());
                mBinding.placeProfileAcAddressText.setText(mPlaceInfo.getAddress());
                mBinding.placeProfileAcPhoneText.setText(mPlaceInfo.getPhone());
                mBinding.placeProfileAcPlaceTypeText.setText(mPlaceInfo.getPlaceType().toUpperCase());
                mBinding.placeProfileAcToolbar.setTitle(mPlaceInfo.getPlaceName());
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPlaceFaved = new DbTasks(getActivity()).isPlaceInDb(mPlaceId);
        if (mPlaceFaved) {
        ...
        mBinding.placeProfileAcFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!(new DbTasks(getActivity()).isPlaceInDb(mPlaceId))) {
                    new DbTasks(getActivity()).execute(new DbTaskParams(DbTasks.TASK_FAV_PLACE, mPlaceInfo));
                    Snackbar.make(mBinding.getRoot(), getString(R.string.added_to_fav), Snackbar.LENGTH_SHORT).show();
                    mBinding.placeProfileAcFab.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(getActivity(), R.color.colorPrimaryDark)));
                } else {
                    new DbTasks(getActivity()).execute(new DbTaskParams(DbTasks.TASK_DELETE_FROM_FAV_PLACE, mPlaceInfo));
